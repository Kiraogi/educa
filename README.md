...
Также обратите внимание: текущий `requirements.txt` в корне выглядит сохранённым в UTF‑16 (видны нулевые байты). Если при установке зависимостей `pip` ругается на формат файла, пересохраните его в UTF‑8.
